...
CREATE TABLE `training_resource` (
  `training_resource_id` bigint(20) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `training_resource` VALUES (1,15,'java','java backend','backend','aaeazzenk'),(2,18,'angular 5','angular 5','frontend','annngulaar');
