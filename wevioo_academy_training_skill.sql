...
CREATE TABLE `training_skill` (
  ...
  CONSTRAINT `FK605jveneni42ko1jqnmuyk8p6` FOREIGN KEY (`training_id`) REFERENCES `training` (`training_id`),
  CONSTRAINT `FKmia309ubw0xxp43is9iowvll6` FOREIGN KEY (`skill_id`) REFERENCES `skill` (`skill_id`)
...
INSERT INTO `training_skill` VALUES (1,1,15,4,1,3),(4,3,18,4,1,1);
